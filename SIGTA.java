...
public class SIGTA {
    ...
    static String[] logBarang = new String[100]; // Array untuk log barang
    static int logCounter = 0; // Counter untuk log barang
        ...
        if (user == 0) {
            ...
            while (dataBaru) {
                ...
                for (int r = 0; r < jumlahBarang; r++) {
                    ...
                    System.out.println("Barang: " + namaBarang[itemcount + r] + " | Tipe Barang: "
                            + tipeBarang[itemcount + r] + " | Jumlah: " + pemasukan[1][itemcount + r]);
                    logBarang[logCounter] = "Barang Masuk: " + namaBarang[itemcount + r] + " | Jumlah: "
                            + pemasukan[1][itemcount + r];
                    logCounter++;
                        ...
                        if (nomorBarang > 0 && nomorBarang <= jumlahBarangNota) {
                            ...
                            if (jumlahBaru >= 0) {
                                ...
                                if (isBarangMasuk) {
                                    ...
                                    laporanKeluar[jumlahLaporanKeluar] = "Barang Keluar: "
                                            + namaBarang[counter - jumlahBarangNota + nomorBarang - 1]
                                            + "\n Jumlah: "
                                            + pemasukan[1][counter - jumlahBarangNota + nomorBarang - 1];
                                    jumlahLaporanKeluar++;

                                    // Memeriksa dan memperbarui barang keluar terbanyak
                                    if (pemasukan[1][counter - jumlahBarangNota + nomorBarang
                                            - 1] > jumlahKeluarTerbanyak) {
                                        jumlahKeluarTerbanyak = pemasukan[1][counter - jumlahBarangNota + nomorBarang
                                                - 1];
                                        barangKeluarTerbanyak = namaBarang[counter - jumlahBarangNota + nomorBarang
                                                - 1];
                                    }
                                }
                                ...
                                System.out.println("================================================");
                                System.out.println(" ");
                                logBarang[logCounter] = "Update Barang: "
                                        + namaBarang[counter - jumlahBarangNota + nomorBarang - 1] + " | Jumlah baru: "
                                        + jumlahBaru;
                                logCounter++;
    ...
    static void tampilkanLaporanBarangRusak() {
        if (user == 0) {
            ...
            System.out.println(
                    "Barang Masuk Terbanyak: " + barangMasukTerbanyak + " (Jumlah: " + jumlahMasukTerbanyak + ")");
            System.out.println(
                    "Barang Keluar Terbanyak: " + barangKeluarTerbanyak + " (Jumlah: " + jumlahKeluarTerbanyak + ")");
    ...
    static void tampilkanLogBarang() {
        System.out.println("|=======================================|");
        System.out.println("|         LOG BARANG YANG TELAH         |");
        System.out.println("|          DIINPUT ATAU DIUBAH          |");
        System.out.println("|=======================================|");

        for (int i = 0; i < logCounter; i++) {
            System.out.println("Log " + (i + 1) + ": " + logBarang[i]);
            System.out.println("|=======================================|");
        }
    }
